#!/bin/bash
ffile="FF_energies_FREYA.DAT"
#ffile="FF_energies_GC.DAT"
#spinIO=$2
...
root -l <<ROOTANASTOP
.L ana_anabella.cpp
ana_bella("FF_energies_FREYA.DAT",236,92)
...
for AA in $(seq 76 1 160) ; do
#for AA in $(seq 166 -1 70) ; do

echo "executing ./ana_bellanubar.sh $AA $ffile $spinIO"
./ana_bellanubar.sh $AA
...
leg->AddEntry(gX4,"Vorobyev et al. (X4)","lp");
